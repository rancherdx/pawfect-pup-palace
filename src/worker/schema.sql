...
CREATE TABLE IF NOT EXISTS puppies (
  ...
  breed_id TEXT REFERENCES breeds(id) ON DELETE SET NULL, -- Added breed_id directly to puppies
...
CREATE INDEX IF NOT EXISTS idx_puppies_breed_id ON puppies(breed_id); -- Added index for puppy.breed_id
