/**
 * @file This file contains the auto-generated TypeScript types for the Supabase database schema.
 * It is generated by the Supabase CLI based on the database schema.
 * @see https://supabase.com/docs/guides/database/api/generating-types
 *
 * It is recommended to not edit this file directly, as changes will be overwritten
